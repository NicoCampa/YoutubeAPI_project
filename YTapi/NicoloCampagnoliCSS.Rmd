...
![wordcloud](plots/Rplot02.png) 


  
• The result sometimes could be crowded, so instead we can visualize the frequencies by a barplot:
![barplot](plots/Rplot03.png)  

We can see among the most frequent words, suggestions of positive sentiment. Which will be explored in the next section.  
...
![Thumbnails of the selected videos](plots/Rplot04.png "Thumbnails of the selected videos")  


### 2.3.2 NRC Lexicon
We try also the NRC lexicon for comparison and to see if the results are consistent with respect to Bing.  
![Thumbnails of the selected videos](plots/Rplot05.png "Thumbnails of the selected videos")  

• Those dictionaries highlighted words crucial to sentiment. They will be the ground field for the next analyses. We aim to explore what those words refer to. To further enrich the debate about Virtual Reality pros and cons. The NRC package unlocks the possibility to explore the distribution of a spectrum of emotions:  
![Thumbnails of the selected videos](plots/Rplot06.png "Thumbnails of the selected videos")  
...
![](plots/image.png "Word association")  

• We started to explore possibles topic of discussion from big polarity players. The method has been tried on all the words not always discovering something usefull. This is because word association is not directly related to frequency but instead refers to the term pairings.  


## 2.5 Bi-Grams
Until now we have considered tokens of uni-grams, which means just 1 word at a time. By examing how frequently one word is followed by another, we can build an idea on the most common topics. For istance, by analyzing the frequency and occurrence of bi-grams in large text corpora, predictive text systems can suggest the most likely next word based on the current word input, this is commonly used in keyboard software on smartphones. I decided to not consider emojis because the most frequent bi-grams would have been in that case, ‘smiling-face’, ‘red-heart’, and so on. Their inclusion would have led to a lot of noise in the following graphs. We start by having a look at the top 10 bi-grams by frequency:  
...
## 2.8 Topic Modelling  
Topic modeling is a statistical method for uncovering the underlying thematic structure in a large corpus of text. By analyzing patterns of word occurrences across documents, it identifies topics—clusters of related words—that represent the main subjects discussed in the corpus. The most common approach to topic modeling is Latent Dirichlet Allocation (LDA), where the algorithm assigns each document a mixture of topics and each topic a distribution of words, based on the assumption that documents are produced from a mixture of these topics. We apply this technique to our data. In the following plots the red indicates the term frequency in the topic while the light blu bar indicates the overall frequency of the term:  

\begin{center}
\includegraphics[width=1\linewidth]{plotsTopic/image-8.png}
\end{center}
• The first topic appears to be centered around people's attitudes and thoughts towards technology, with a focus on the desire for technological advancement and the problems that need to be addressed. The high frequency of words like "people," "think," "technology," "things," "already," "even," "time," "many," and "want" suggests a discussion about the current state of technology and people's expectations of it. There's also an indication of a desire for progress with words like "way," "make," "tech," and "need." The presence of words like "problem," "lot," "used," "long," "enough," and "social" could imply concerns about technological impacts on society or issues that are perceived as long-standing and perhaps not adequately addressed yet. The inclusion of "phones" and "experience" at the bottom of the list hints that the conversation may include specific technology such as smartphones and user experience.  
• The second one is more speculative and possibly philosophical, focusing on the potential future impacts of virtual reality on society and individuals. Words like "will," "world," "real," "life," "reality," "day," "live," "change," "society," "everyone," "one," "human," and "every" imply broad and deep impacts on daily life and society as a whole. The discussion might be addressing how virtual reality could change the way people live and interact. "Brain," "true," "become," "new," "believe," "god," "end," "never," and "living" are particularly powerful, suggesting transformative effects on human cognition, belief systems, and perhaps even touching on existential topics. The mention of "virtual" towards the end reaffirms the subject of virtual reality.  

\begin{center}
\includegraphics[width=1\linewidth]{plotsTopic/image-8 copy.png}
\end{center}
• Topic 3: The dominant words in this topic are very specific to virtual reality hardware and its ecosystem. Words like "vision," "pro," "headset," "quest," "use," "work," "games," "mac," and "meta" suggest a discussion about the Apple Vision Pro's compatibility with various devices (like Mac computers) and possibly a comparison with other VR headsets (like those from Meta, formerly known as Facebook). The word "quest" might be referring to the Oculus Quest, another popular VR headset, indicating comparisons or compatibility queries. The presence of "app," "apps," "play," "gaming," "game," and "virtual" indicates a focus on the applications and gaming potential of the headset. Lastly, "experience," "display," "device," "computer," "space," "windows," "screen," "ipad," "tracking," "computing," and "hand" highlight technical specifications and features such as the display quality, tracking accuracy, and how the device interacts with other computing platforms like Windows or iPad.  
• Topic 4: This topic seems to be concerned with the practicalities of using the device. Words like "battery," "use," "phone," "headset," "device," "need," "can," "make," "way," "get," "head," "much," "put," and "hours" suggest discussions about the battery life of the headset, how it is used with phones, and how comfortable it is to wear for extended periods ("head" and "hours"). "Replace," "probably," "also," "power," "even," "less," "big," "cable," "iphone," "mah" (milliampere-hour, a unit for measuring electric power over time), and "phones" hint at considerations around battery replacement, charging methods, and power requirements. "Small," "another," and "used" may refer to the size of the device, the availability of alternative options, or the market for used devices.  
...
• Topic 5: This topic seems to revolve around consumer opinions regarding Apple's products and pricing strategy. The frequent mention of "apple," "product," "price," "better," "made," "make," "new," "products," and "still" suggests a focus on the quality, innovation, and release of new products from Apple. "Much," "expensive," "hate," "market," "cost," "hard," and "company" indicate discussions about the high price point of Apple products and possibly a negative sentiment towards the cost or the difficulty of affording these products. The word "cheaper" could be in reference to a desire for more affordable options. The presence of "tech," "sell," "pay," "making," "overpriced," "samsung," "buying," "easy," "point," "high," and "oculus" suggests comparisons with competitors like Samsung and Oculus, with discussions on value for money and the competitive tech market.

• Topic 6: This topic appears to be more focused on the experience and visual aspects of using Apple's virtual reality products. The words "can," "see," "imagine," "one," "eyes," "around," "face," "wearing," and "someone" all relate to the visual and immersive experience of VR. "Screen," "looking," "eye," "ready," "person," "able," "player," "front," "movie," "seeing," "wonder," "show," "using," "walking," "close," "getting," "hands," "talking," "car," and "room" further underscore the various contexts in which VR technology can be used—from gaming to movies to virtual meetings—and the physical interactions involved. This might include comments on the quality of the visual display, the comfort of the headset, and the overall readiness of VR technology for various uses, whether for entertainment or practical applications.
